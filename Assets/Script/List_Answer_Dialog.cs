...
public class List_Answer_Dialog : MonoBehaviour
{
    ...
    public List<Button_Controller> list_btn;
    public List<AnswerUi> list_an_UI;
    ...
    public void CheckState()
    {
        list_btn.Clear();
        list_an_UI.Clear();
        list_btn = new List<Button_Controller>(GetComponentsInChildren<Button_Controller>());
        list_an_UI = new List<AnswerUi>(GetComponentsInChildren<AnswerUi>());
        for(int i = 0; i < list_an_UI.Count; i++)
        {
